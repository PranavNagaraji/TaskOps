...
const {getAllEmployees, addEmployee, updateEmployeeStatus, deleteEmployee}=require('../models/employeesModel');
...
module.exports={getEmployees, addOneEmployee, updateStatus, deleteOneEmployee};