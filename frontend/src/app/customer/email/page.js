...
export default function CustomerEmailPage() {
  ...
  const onSubmit = async (e) => {
    ...
    setToast(null);
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/customers/email`, {
        method: "POST",
    ...
    <div className="min-h-screen bg-gray-50 p-6 sm:p-10">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-2">Send us a message for complaints, requests, or anything else.</p>
        </div>
