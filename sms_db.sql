...
CREATE TABLE PAYMENTS (
    ...
    STATUS VARCHAR2(20),
    CONSTRAINT CHK_PAYMENT_METHOD CHECK (UPPER(PAYMENT_METHOD) IN ('CASH','CARD','UPI','NETBANKING')),
    CONSTRAINT CHK_PAYMENT_STATUS CHECK (UPPER(STATUS) IN ('PENDING','COMPLETED','FAILED')),
    CONSTRAINT FK_REQUEST_PAYMENT FOREIGN KEY (REQUEST_ID)
        REFERENCES REQUESTS(REQUEST_ID) ON DELETE CASCADE
);
